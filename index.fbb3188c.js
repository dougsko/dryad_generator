...
var _codeBookJson = require("./codeBook.json");
...
function generateDryadTable(id) {
    ...
    const columnTextLengths = [
        ...
        2,
        2
    ]; // Specific text lengths for each column
...
function generateCodeBook(elementId) {
    ...
    let words = _codeBookJson.words.sort();
    for(let i = 0; i < 17; i++){
        ...
        for(let j = 0; j < 6; j++){
            ...
            let word = " ";
            if (_codeBookJson.words[wordIndex] === undefined) word = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; // Placeholder for empty cell
            else word = _codeBookJson.words[wordIndex];
            if (_codeBookJson.numbers[wordIndex]) span.innerHTML = `${_codeBookJson.numbers[wordIndex]} ${word}`;
        }
    }
}
/*function generateCodeBook(elementId) {
...
},{"./codeBook.json":"be3ta","uuid":"j4KJi"}],"be3ta":[function(require,module,exports) {
module.exports = JSON.parse('{"numbers":["000","019","028","037","046","055","064","073","082","091","109","118","127","136","145","154","163","172","181","190","199","208","217","226","235","244","253","262","271","280","307","316","325","334","343","352","361","370","389","398","406","415","424","433","442","451","460","479","488","497","505","514","523","532","541","550","569","578","587","596","604","613","622","631","640","659","668","677","686","695","703","712","721","730","749","758","767","776","785","794","802","811","820","839","848","857","866","875","884","893","901","910","929","938","947","956","965","974","983","992"],"words":[]}');
...
},{"./validate.js":"eHPgI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kzbYw","bDbGG"], "bDbGG", "parcelRequiree8c5")
