...
function generateCodeBook(elementId) {
    ...
    for(let i = 0; i < 11; i++){
        ...
        span.appendChild(document.createTextNode(_codeBookJson.numbers[i] + " " + words[i]));
        td = row.insertCell(1);
        span = td.appendChild(document.createElement("span"));
        span.setAttribute("class", "upperCase");
        span.appendChild(document.createTextNode(_codeBookJson.numbers[i + 11] + " " + words[i + 11]));
        td = row.insertCell(2);
        span = td.appendChild(document.createElement("span"));
        span.setAttribute("class", "upperCase");
        span.appendChild(document.createTextNode(_codeBookJson.numbers[i + 22] + " " + words[i + 22]));
        td = row.insertCell(3);
        span = td.appendChild(document.createElement("span"));
        span.setAttribute("class", "upperCase");
        let word = " ";
        if (_codeBookJson.words[i + 33] == undefined) word = "";
        else word = _codeBookJson.words[i + 33];
        span.appendChild(document.createTextNode(_codeBookJson.numbers[i + 33] + " " + word));
    }
}
